...
python2 train.py --id $id --caption_model SLD \
    --label_smoothing 0.0 \
    --input_json data/refcoco.json --input_label_h5 data/refcoco_label.h5 \
    --input_fc_dir /usr0/home/yansenwa/mscoco_feature/boxes/bu_feature_gt/refcoco_unc/cocobu_ref_fc --input_att_dir /usr0/home/yansenwa/mscoco_feature/boxes/bu_feature_gt/refcoco_unc/cocobu_ref_att \
    --seq_per_img 3 --batch_size 25 --beam_size 1 --num_layers 6 --input_encoding_size 512 --rnn_size 2048 \
    --reduce_on_plateau --learning_rate_decay_start 0 --scheduled_sampling_start 0 --checkpoint_path checkpoint/pretrain2 \
    --save_checkpoint_every 200 --language_eval 1 --val_images_use 5000 --max_epochs 10 --learning_rate 5e-4 | tee $ckpt_path/train.log 
