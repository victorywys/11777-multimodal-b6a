...
python2 train.py --id $id --caption_model SLD \
    ...
    --reduce_on_plateau --learning_rate_decay_start 0 --scheduled_sampling_start 0 --checkpoint_path checkpoint/pretrain \
    --save_checkpoint_every 20 --language_eval 1 --val_images_use 5000 --max_epochs 15 --learning_rate 5e-4 | tee $ckpt_path/train.log 
