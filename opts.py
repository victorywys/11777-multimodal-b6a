...
def parse_opt():
    ...
    # REFCOCO
    parser.add_argument('--ref_ann_feats', type=str, default='/usr0/home/yansenwa/refcoco_unc/ann_feats.npy')
    parser.add_argument('--ref_image_feats', type=str, default='/usr0/home/yansenwa/refcoco_unc/image_feats.npy')
    parser.add_argument('--ref_infos', type=str, default='/usr0/home/yansenwa/refcoco_unc/data.json')
