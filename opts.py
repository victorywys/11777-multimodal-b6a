...
def parse_opt():
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--discriminator_start_from', type=str, default=None,
                    help='')
    ...
    parser.add_argument('--train_mode', type=str, default="pretrain",
                    help='pretrain, discriminator, generator')
    parser.add_argument('--caption_model', type=str, default="show_tell",
                    help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer, SLD')
    ...
    parser.add_argument('--logit_layers', type=int, default=1,
                    help='number of layers in the RNN')
    parser.add_argument('--listener_embedding_size', type=int, default=512,
                    help='the embedding size for image and labels in the listener')
    parser.add_argument('--listener_num_layers', type=int, default=2,
                    help='number of layers to get the embeddings in the listener')
