...
python2 train.py --id $id --dis_id $dis_id --caption_model sl --train_mode discriminator\
    ...
    --start_from log/log_refcocog_gen \
    --save_checkpoint_every 1000 --language_eval 0 --val_images_use 5000 --max_epochs 8 --learning_rate 5e-4 | tee $ckpt_path/train.log
